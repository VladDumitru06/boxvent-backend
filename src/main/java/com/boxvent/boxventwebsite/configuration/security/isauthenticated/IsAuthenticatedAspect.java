package com.boxvent.boxventwebsite.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.boxvent.boxventwebsite.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.boxvent.boxventwebsite.configuration.security.isauthenticated.IsAuthenticated)")
